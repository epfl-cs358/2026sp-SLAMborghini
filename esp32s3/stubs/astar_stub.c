...
path_t astar_stub_straight(void)
{
    ...
    /* Waypoint 0: start */
    path.waypoints[0].x        = 0;
    path.waypoints[0].y        = 0;
    path.waypoints[0].theta    = 0.0f;
    path.waypoints[0].v_target = 300u;

    /* Waypoint 1: 500 mm ahead */
    path.waypoints[1].x        = 500;
    path.waypoints[1].y        = 0;
    path.waypoints[1].theta    = 0.0f;
    path.waypoints[1].v_target = 300u;

    /* Waypoint 2: 1000 mm ahead */
    path.waypoints[2].x        = 1000;
    path.waypoints[2].y        = 0;
    path.waypoints[2].theta    = 0.0f;
    path.waypoints[2].v_target = 300u;
